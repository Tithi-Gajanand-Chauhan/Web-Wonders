...
function AuthModal({ isOpen, onClose, onAuthSuccess }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://cinecircle-backend-gjfd.onrender.com/api/auth/login', {
        method: 'POST',
        headers: {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch('https://cinecircle-backend-gjfd.onrender.com/api/auth/register', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
